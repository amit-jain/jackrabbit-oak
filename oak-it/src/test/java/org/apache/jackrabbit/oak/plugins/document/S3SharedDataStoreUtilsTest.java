 ...
 */
public class S3SharedDataStoreUtilsTest extends SharedDataStoreUtilsTest {
    private static final Logger log = LoggerFactory.getLogger(S3SharedDataStoreUtilsTest.class);
